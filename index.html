...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Pernikahan &mdash; Eddy & Lilik</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Pernikahan Eddy & Lilik" />
	<meta name="author" content="Djazuli IT" />


	<meta property="og:title" content="Pernikahan Eddy & Lilik"/>
	<meta property="og:image" content="images/nikah.png"/>
	<meta property="og:url" content=""/>
	<meta property="og:site_name" content="Pernikahan Eddy & Lilik"/>
	<meta property="og:description" content="Pernikahan Eddy & Lilik"/>
	<meta name="twitter:title" content="Pernikahan Eddy & Lilik" />
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="container">
			<div class="row">
				<div class="col-xs-2">
					<div id="fh5co-logo"><a href="index.html">Pernikahan<strong>.</strong></a></div>
				</div>
				<div class="col-xs-10 text-right menu-1">
					<ul>
						<li class="active"><a href="#beranda">Beranda</a></li>
						<li><a href="#acara">Acara</a></li>
						<li><a href="#map">Denah</a></li>
	...
	<header id="fh5co-header" class="fh5co-cover" role="banner" style="background-image:url(images/img_bg_2.jpg); background-size: cover;" data-stellar-background-ratio="0.5">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center fh5co-heading animate-box">
					...
					<h3>Sabtu, 30 September 2023, Boja, Semarang</h3>
					<p>Akad Nikah Kami</p>
				</div>
			</div>
			<div class="couple-wrap animate-box">
				...
				<div class="couple-half">
					...
					<div class="desc-bride">
						<h3>Yuli Kartika Dwi Rismanti</h3>
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="col-md-6 col-sm-6 text-center">
								<div class="event-wrap animate-box">
									...
									<div class="event-col">
										<i class="icon-clock"></i>
										<span>09:00 s/d 11:00</span>
										<span>13:00 s/d 15:00</span>
									</div>
									<div class="event-col">
										<i class="icon-calendar"></i>
										<span>Ahad, 3</span>
							...
							<div class="owl-carousel-fullwidth">
								<div class="item">
									<div class="testimony-slide active text-center">
										...
										<blockquote>
											<p>“Dan segala sesuatu Kami Ciptakan Berpasang-pasangan supaya kamu mengingat kebesaran Allah.”(QS Az-Zariyat: 49)</p>
										</blockquote>
									</div>
								</div>
								...
								<div class="item">
									<div class="testimony-slide active text-center">
										...
										<span>Allah Berfirman:</span>
										<blockquote>
											<p>“Bagaimana kamu akan mengambilnya kembali, padahal sebagian kamu telah bergaul (bercampur) dengan yang lain sebagai suami-isteri. Dan mereka (isteri-isterimu) telah mengambil dari kamu perjanjian yang kuat.” (QS An-Nisa: 21)</p>
										</blockquote>
									</div>
								</div>
								<div class="item">
